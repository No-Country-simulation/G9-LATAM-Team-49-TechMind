...
INSTALAR = False  # ponlo en False si ya instalaste las dependencias
...
class ConfigRutas:
    ...
    @property
    def raw(self) -> Path:        return self.base / "data" / "raw"
    @property
    def processed(self) -> Path:  return self.base / "data" / "processed"
    @property
